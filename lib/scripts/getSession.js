		...
		if (cookies.filter(
			...
			getUser(function(response) {
				if(response.success) {
					...
					document.cookie = 'graphjs_' + key + '_id=' + response.id + '; path=/; expires=' + expiry.toGMTString() + '; samesite=secure';;
					document.cookie = 'graphjs_' + key + '_username=' + response.username + '; path=/; expires=' + expiry.toGMTString() + '; samesite=secure';;
				} else {

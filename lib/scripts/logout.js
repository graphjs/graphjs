...
function logoutCall(callback) {
	...
	function(response) {
		if(response.data.success) {
			...
			document.cookie = 'graphjs_' + key + '_id=; path=/; expires=Thu, 01 Jan 1970 00:00:01 GMT; samesite=secure;';
			document.cookie = 'graphjs_' + key + '_username=; path=/; expires=Thu, 01 Jan 1970 00:00:01 GMT; samesite=secure;';

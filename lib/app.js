...
const init = function(id, settings = {}) {
	...
	window.GraphJSConfig['host'] = settings.host || 'https://accounts.graphjs.com';
...
import GraphJSScripts from './tagsImports';
window.GraphJS = GraphJSScripts;
...
window.GraphJS = {
	...
	showOverlay,
	// authentication
	getSession, getUser, login, logout, register, reset, verify, verifyEmailCode,
	showAlert, showAuth, showLogin, showRegister, showReset, showVerify,
	...GraphJSScripts
}

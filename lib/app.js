...
const init = function(id, settings = {}) {
	...
	window.GraphJSConfig['host'] = settings.host;
	...
	window.GraphJSConfig['language'] = ListOfLanguagesAvailable.indexOf(settings.language) !== -1 ? settings.language : 'english';
...
window.GraphJS = {
	...
	updateStatus, removeStatusUpdate, // Feed

...
import './docs/tags/auth-state.tag';
...
import './docs/tags/forum-composer.tag';
import './docs/tags/group.tag';
import './docs/tags/group-card.tag';
import './docs/tags/messages.tag';
import './docs/tags/messages-composer.tag';
import './docs/tags/profile.tag';
import './docs/tags/profile-card.tag';
import './docs/tags/list.tag';
import './docs/functions/showAlert.tag';
import './docs/functions/showAuth.tag';
import './docs/functions/showLogin.tag';
import './docs/functions/showRegister.tag';
import './docs/functions/showReset.tag';
import './docs/functions/showComments.tag';
import './docs/functions/showForum.tag';
import './docs/functions/showForumList.tag';
import './docs/functions/showForumThread.tag';
import './docs/functions/showForumComposer.tag';
import './docs/functions/showMessages.tag';
import './docs/functions/showMessagesComposer.tag';
import './docs/functions/showProfile.tag';
import './docs/functions/showGroup.tag';
import './docs/functions/showGroupCreator.tag';
...
export {
	...
	getSession, getUser, login, logout, register, reset, // Authentication
	...
	showAlert, showAuth, showAuthLogin, showAuthRegister, showAuthReset, showComments, showForum, showForumComposer, showForumList, showForumThread, showGroup, showGroupCreator, showMessagesComposer, showMessages, showOverlay, showProfile, // Show

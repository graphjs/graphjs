var Pho = function (id) {
	...
	var SignupForm = Vue.component('signup-form', {
	  ...
	  methods: {
	    onRegister: function() {
	      apiInstance.get(`/signup?username=${this.model.username}&password=${this.model.password}&email=${this.model.email}`)
	...
	var LoginForm = Vue.component('login-form', {
	  ...
	  methods: {
	    onLogin: function() {
	      apiInstance.get(`/login?username=${this.model.username}&password=${this.model.password}`)
			  .then(function (response) {          
			    // console.log(response);
			  })
			  .catch(function (error) {
        ...
        apiInstance.get(`/whoami?id=4c71650514e22a1f54e33f19d07de440`).then((res) => {
          console.log(res);
        })
	    }
	  }

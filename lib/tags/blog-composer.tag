...
>
    ...
    <div class={'graphjs-content' + (loaded ? '' : ' graphjs-loading') + (blocked ? ' graphjs-blocked' : '')}>
        <form ref="form" if={editable}>
            ...
            <!-- <div ref="body" class="graphjs-body" contenteditable="true" placeholder="Compose your post here..."></div> -->
        </form>
        <div if={!editable}>
            <p>You don't have permission to write/edit this post.</p>
        </div>
    ...
    <script>
        ...
        this.handleSubmit = (event) => {
            ...
            /* this.validateForm() && */ startBlogPost(

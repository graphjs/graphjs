<graphjs-feed-composer class="graphjs-root graphjs-box" style={
    ...
    <style type="less">
        ...
        @import '../styles/components/feed-composer.less';
        @prefix: graphjs;

        @{prefix}-feed-composer.@{prefix}-root {
            display: block;
            ...
            .@{prefix}-content {
                ...
                .@{prefix}-options {
                    display: inline-block;
                    width: 100%;
                    border-top: 1px solid fade(@default-color, 10%);
                    background-color: fade(@default-color, 10%);
                    .clearfix;
                    & > * {
                        float: left;
                    ...
                    button {
                        ...
                        font-size: 1em;
                        .border-radius(0);
                        .background-color-states(@default-color);
                    }
                }
            }
        }
        ...
        this.on('mount', function() {
            ...
            photo.addEventListener("click", function() {
                cloudinary.openUploadWidget({
                    ...
                    multiple: true,
                    resource_type: 'image',
                    folder: 'users/' + self.userId + '/photos',
                    theme: 'minimal'
                },
            ...
            video.addEventListener("click", function() {
                cloudinary.openUploadWidget({
                    ...
                    multiple: false,
                    resource_type: 'video',
                    folder: 'users/' + self.userId + '/videos',
                    theme: 'minimal'
                },
                function(error, result) {
                    if(result) {

<graphjs-bookmark-button class="box"}>
    <a class={this.active ? 'active' : ''} onclick={handleBookmark}>
        <div class={this.type + ' icon'}>
            <svg if={this.type == 'favorite'} viewBox="0 0 62 58" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <svg if={this.type == 'like'} viewBox="0 0 42 54" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <svg if={this.type == 'love'} viewBox="0 0 81 71" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <svg if={this.type == 'save'} viewBox="0 0 72 88" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">

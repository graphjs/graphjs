    ...
    <div class={'content' + (loaded ? '' : ' loading') + (blocked ? ' blocked' : '')}>
        <div class="sidebar">
            ...
            <div class="list" ref="partners">
                <a class={'item' + (list[partner] && list[partner].is_read ? '' : ' unread') + (activePartner == partner ? ' active' : '')} each={partner in partners} data-partner={partner} onclick={handleDisplay}>

...
>
    <div class={'graphjs-content' + (loaded ? '' : ' graphjs-loading') + (blocked ? ' graphjs-blocked' : '')}>
        ...
        <div if={!deleted} class="graphjs-post" ref="scrollingContent">
            <h1 class="graphjs-title" if={title}>{title}</h1>
        ...
        <button if={blocked} onclick={handleBlock} class="graphjs-blockage">Login to display post</button>
    </div>
    <a class="graphjs-promo graphjs-bottom graphjs-center graphjs-rounded graphjs-detached" href="https://graphjs.com" target="_blank">

<docs-getConversation>
    ...
    <section class="options">
        <form>
            <fieldset name="with">
                <legend>With</legend>
                <input onkeyup={updateText} type="text" value={specs.with} />
            </fieldset>
        </form>
    </section>
    <h2>Code</h2>
    ...
    <script>
        ...
        import getConversation from '../../../lib/scripts/getConversation.js';

        this.input = '';
        this.response = '';
        this.specs = {
            "with": "48760696099368953dd71a90b727acba"
        }

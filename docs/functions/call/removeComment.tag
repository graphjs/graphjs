<docs-removeComment>
    ...
    <section class="options">
        <form>
            <fieldset name="id">
                ...
                <input onkeyup={updateText} type="text" value={specs.comment_id} placeholder="A comment id is required" />
            </fieldset>
        </form>
    </section>
    <h2>Code</h2>
    ...
    <script>
        ...
        import removeComment from '../../../lib/scripts/removeComment.js';
